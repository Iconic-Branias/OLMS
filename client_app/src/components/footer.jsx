				...
				<div class="sm:flex sm:flex-wrap sm:-mx-4 md:py-4">
					...
					<div class="px-4 mt-4 sm:w-1/3 xl:w-1/6 sm:mx-auto xl:mt-0 xl:ml-auto">
						...
						<div class="flex sm:justify-center xl:justify-start">
							<a
								href="/"
								class="border-2 border-gray-400 rounded-md px-1 text-center py-1 text-gray-600 hover:text-white hover:bg-blue-600 hover:border-blue-600"
							>
								<svg
							...
							<a
								href="/"
								class="border-2 border-gray-400 rounded-md px-1 text-center py-1 ml-2 text-gray-600 hover:text-white hover:bg-blue-400 hover:border-blue-400"
							>
								<svg
									xmlns="http://www.w3.org/2000/svg"
									width="24"
							...
							<a
								href="/"
								class="border-2 border-gray-400 rounded-md px-1 text-center py-1 ml-2 text-gray-600 hover:text-white hover:bg-red-600 hover:border-red-600"
							>
								<svg
									xmlns="http://www.w3.org/2000/svg"
									width="24"
